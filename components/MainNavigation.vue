        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              { href: '/components/bottom-navigation', title: 'Bottom navigation', action: 'fa-arrow-circle-o-up' },
              ...
              { href: '/components/pagination', title: 'Pagination', action: 'fa-arrow-circle-o-up' },
              ...
              { href: '/components/tabs', title: 'Tabs', action: 'fa-arrow-circle-o-up' },
